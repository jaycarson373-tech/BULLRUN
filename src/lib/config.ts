...
export const config = {
  ...
  championshipVaultWallet: readEnv("CHAMPIONSHIP_VAULT_WALLET"),
  claimWalletPrivateKey: readEnv("CLAIM_WALLET_PRIVATE_KEY"),
  payoutSignerPrivateKey: readEnv("PAYOUT_SIGNER_PRIVATE_KEY"),
  winningBullRewardPrivateKey: readEnv("WINNING_BULL_REWARD_PRIVATE_KEY"),
