...
function CurrentRace({ currentRace }: { currentRace: CurrentRaceView }) {
  ...
  return (
    <section id="live-race" className="relative overflow-hidden border-b border-[#241013] bg-[#070707]">
      <img src="/images/bullrun-arena-live.jpg" alt="" className="absolute inset-0 h-full w-full object-cover opacity-[0.16]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,#050505_0%,rgba(5,5,5,0.82)_42%,#050505_100%)]" />
...
function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="relative overflow-hidden border-b border-[#241013] bg-[#050505]">
      <img src="/images/bullrun-arena-gate.jpg" alt="" className="absolute inset-0 h-full w-full object-cover opacity-[0.18]" />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,#050505,rgba(5,5,5,0.76),#050505)]" />
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-7">
...
function Treasury({ summary }: { summary: DistributionSummary }) {
  return (
    <section className="relative overflow-hidden bg-[#050505]">
      <img src="/images/bullrun-arena-floor.jpg" alt="" className="absolute inset-0 h-full w-full object-cover opacity-[0.22]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,#050505,rgba(5,5,5,0.72),#050505)]" />
...
function FooterCta() {
  return (
    <section className="relative overflow-hidden border-t border-[#241013] bg-black">
      <img src="/images/bullrun-arena-smoke.jpg" alt="" className="absolute inset-0 h-full w-full object-cover opacity-[0.26]" />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,#050505,rgba(5,5,5,0.76),#050505)]" />
